...
<head>
    ...
    <link href="backend/vendor/vector-map/jqvmap.min.css" rel="stylesheet" media="all">
...
<body class="animsition">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="{{route('room.home')}}">
                    <img src="backend/images/icon/logo-white.png" alt="Cool Admin" />
                </a>
            </div>
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src="backend/images/icon/avatar-big-01.jpg" alt="Minh Duc" />
                    </div>
                    <h4 class="name">Minh Duc</h4>
                    <a href="#">Sign out</a>
                </div>
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        <li class="active ">
                            <a href="#">
                                <i class="fas fa-chart-bar"></i>#emptyCell</a>
                            <span class="inbox-num">3</span>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fas fa-shopping-basket"></i>#emptyCell</a>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <!-- SHOWTIME SIDEBAR -->
                                @include('backend.layouts.display.showTimeSide')
                                <!-- SHOWTIME SIDEBAR -->
                                <li>
                                    <a href="index2.html">
                                        <i class="fas fa-tachometer-alt"></i>#emptyCell</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-chart-pie"></i>Phòng Vé
                                <span class="arrow">
                                    <i class="fas fa-angle-down"></i>
                                </span>
                            </a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <!-- ROOM SIDEBAR -->
                                @include('backend.layouts.display.roomSide')
                                <!-- ROOM SIDEBAR -->
                                <li>
                                    <a href="#">
                                        <i class="fas fa-table"></i>#emptyCell</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-desktop"></i>Thông tin Film
                                <span class="arrow">
                                    <i class="fas fa-angle-down"></i>
                                </span>
                            </a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{route('movieIndex')}}">
                                        <i class="far fa-window-maximize"></i>Film</a>
                                </li>
                                <li>
                                    <a href="{{route('directorIndex')}}">
                                        <i class="fab fa-flickr"></i>Đạo diễn</a>
                                </li>
                                <li>
                                    <a href="{{route('castIndex')}}">
                                        <i class="fas fa-comment-alt"></i>diễn viên</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
        ...
        <div class="page-container2">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <a href="#">
                                    <img src="backend/images/icon/logo-white.png" alt="CoolAdmin" />
                                </a>
                            </div>
            ...
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    <div class="account2">
                        <div class="image img-cir img-120">
                            <img src="backend/images/icon/avatar-big-01.jpg" alt="John Doe" />
                        </div>
    ...
    <script src="backend/vendor/vector-map/jquery.vmap.js"></script>
    <script src="backend/vendor/vector-map/jquery.vmap.min.js"></script>
    <script src="backend/vendor/vector-map/jquery.vmap.sampledata.js"></script>
    <script src="backend/vendor/vector-map/jquery.vmap.world.js"></script>

    <!-- Main JS-->
    <script src="backend/js/main.js"></script>
    <!-- Datetime PICKER -->
    <script src="backend/js/minh-duc-custom.js"></script>
