		...
		<div class="col-sm-9">
			<div class="form-row">
				<div class="form-group col-sm-8">
				      ...
				      <input name="MovieName" type="text" class="form-control" autocomplete="off" placeholder="enter the Name of the new Movie">
				...
				<div class="form-group col-sm-4">
				      ...
				      <input name="Date_Premiere" type="date" data-format="YYYY-mm-dd" class="form-control">
			...
			<div class="form-row">
				<div class="form-group col-sm-8">
				    ...
				    <input name="Title" type="text" class="form-control" autocomplete="off" placeholder="enter Movie Title">
				</div>
				<div class="form-group col-sm-2">
				      <label>Duration Min</label>
				      <input name="Duration_Min" type="text" autocomplete="off" class="form-control">
			  ...
			  <div class="form-group">
			    <label for="inputAddress">Description</label>
			   	<textarea name="Description" type="text" class="form-control" autocomplete="off" rows="3" placeholder="write some Note"></textarea>
			  </div>
			
			  <div class="form-group">
		      	<label>Note</label>
			   	<textarea name="Note" type="text" class="form-control" autocomplete="off" rows="2" placeholder="write some description"></textarea>
			  </div>
			<div class="row">
